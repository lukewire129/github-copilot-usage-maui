...
public partial class DeskBandPage : Component<UsedState>
{
    ...
    HStack DonutMiniCard(string title, double pct)
    {
        ...
        return HStack(
                ...
                Label(title).FontSize(9).TextColor(AppColors.PopupText3).VCenter(),
                Label($"{pct:F0}%")
                    .FontSize(9).FontAttributes(MauiControls.FontAttributes.Bold)
                    .TextColor(fillColor)
                    .VCenter()
            )
            .Spacing(5)
