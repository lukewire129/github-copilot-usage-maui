...
static class AppColors
{
    ...
    public static Color PopupPage        => IsDark ? Color.FromArgb("#121212") : Color.FromArgb("#F5F3EE");
    public static Color PopupCard        => IsDark ? Color.FromArgb("#1E1E1E") : Colors.White;
